              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: _rankCard("2nd", "Coffee Shop", 4.5, Colors.orange),
                      ).animate().fadeIn().slideY(begin: 0.2, curve: Curves.easeOut),
                      SizedBox(width: 12.w),
                      Expanded(
                        child: _rankCard("1st", "Coffee Shop", 4.5, Colors.blueAccent, isBig: true),
                      ).animate(delay: 200.ms).fadeIn().scale(begin: const Offset(0.8, 0.8)),
                      SizedBox(width: 12.w),
                      Expanded(
                        child: _rankCard("3rd", "Coffee Shop", 4.5, Colors.purple),
                  ...
                  /// 🔹 More Shops List with staggered animation
                  ListView.builder(
                    itemCount: 6,
                    shrinkWrap: true,
